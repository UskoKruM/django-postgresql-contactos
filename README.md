# Django-PostgreSQL-Contactos

Aplicación web usando el framework Django con el sistema gestor de bases de datos PostgreSQL para crear una agenda de contactos y enviar correos electrónicos (emails) con Django a través del servidor de Gmail.
